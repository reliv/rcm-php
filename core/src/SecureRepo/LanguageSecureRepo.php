...
class LanguageSecureRepo implements SecurityPropertiesProviderInterface
{
    ...
    public function findAll(array $orderBy = [])
    {
        ...
        return $repo->findBy([], $orderBy);
    }

    public function findSecurityProperties($data): array
    {
        return [
            'type' => SecurityPropertyConstants::TYPE_INTERNATIONAL_STANDARD,
            SecurityPropertyConstants::INTERNATIONAL_STANDARD_TYPE_KEY
            => SecurityPropertyConstants::INTERNATIONAL_STANDARD_TYPE_LANGUAGE
        ];
    }
}
