...
class PageTypeSecureRepo implements SecurityPropertiesProviderInterface
{
    ...
    public function findAll()
    {
        ...
        return $this->config['Rcm']['pageTypes'];
    }
    ...
    public function findSecurityProperties($data): array
    {
        return [
            ...
            => SecurityPropertyConstants::ADMIN_TOOL_TYPE_PAGE_TYPE
        ];
    }
}
