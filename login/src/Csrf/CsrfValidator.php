...
/**
 * This was copied from Zend\Validator\CsrfValidator and then modified to
 * make it not refresh the token every request in order to avoid usability
 * issues.
 * See https://security.stackexchange.com/questions/22903/why-refresh-csrf-token-per-form-request
 * for more info
