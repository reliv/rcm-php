(function (c) {
    ...
    c.fn.tinymce = function (j) {
        ...
        if (!d.tinymce && !e && (g = j.script_url)) {
            ...
            d.tinyMCEPreInit = d.tinyMCEPreInit || {base: h, suffix: n, query: l};
            if (g.indexOf("gzip") != -1) {
                i = j.language || "en";
            ...
            c.ajax({type: "GET", url: g, dataType: "script", cache: true, success: function () {
    ...
    c.extend(c.expr[":"], {tinymce: function (g) {
    ...
    function f() {
            ...
            c.fn[l] = function (s) {
                ...
                if (s !== b) {
                    ...
                    (m ? p : p.eq(0)).each(function (u, v) {
                        var t = h(v);
                        r += t ? (m ? t.getContent().replace(/<(?:"[^"]*"|'[^']*'|[^'">])*>/g, "") : t.getContent({save: true})) : o.apply(c(v), q)
                    });
                    return r
                }
            }
        ...
        c.fn.attr = function (o, q) {
            ...
            if (q !== b) {
                ...
                var p = m[0], l = h(p);
                return l ? l.getContent({save: true}) : j.attr.apply(c(p), n)
            }
        }
    }
})(jQuery);