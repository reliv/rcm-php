(function (e) {
    ...
    var c = {majorVersion: "3", minorVersion: "5.7", releaseDate: "2012-09-20", _init: function () {
...
(function (f, e) {
    var d = e.is, b = /^(href|src|style)$/i, c;
    if (!f && window.console) {
        return console.log("Load jQuery first!")
    }
    e.$ = f;
    e.adapter = {patchEditor: function (j) {
        var i = f.fn;

        function h(m, n) {
            var l = this;
            if (n) {
                l.removeAttr("data-mce-style")
            }
            return i.css.apply(l, arguments)
        }
        ...
        function g(m, n) {
            ...
            if (b.test(m)) {
                if (n !== c) {
                    l.each(function (o, p) {
                        j.dom.setAttrib(p, m, n)
                    });
                    return l
                } else {
                    return l.attr("data-mce-" + m)
                }
            }
            return i.attr.apply(l, arguments)
        }
        ...
        function k(l) {
            if (l.css !== h) {
                ...
                l.attr = g;
                l.tinymce = j;
                l.pushStack = function () {
                    return k(i.pushStack.apply(this, arguments))
                }
            }
            return l
        }
    ...
    e.extend = f.extend;
    e.extend(e, {map: f.map, grep: function (g, h) {
        return f.grep(g, h || function () {
            return 1
        })
    }, inArray: function (g, h) {
        return f.inArray(h, g || [])
    }});
    var a = {"tinymce.dom.DOMUtils": {select: function (i, h) {
        var g = this;
        return f.find(i, g.get(h) || g.get(g.settings.root_element) || g.doc, [])
    }, is: function (h, g) {
        return f(this.get(h)).is(g)
    }}};
    e.onCreate = function (g, i, h) {
        e.extend(h, a[i])
    }
...
tinymce.util.Quirks = function (e) {
    var n = tinymce.VK, x = n.BACKSPACE, y = n.DELETE, q = e.dom, I = e.selection, v = e.settings, c = e.parser, u = e.serializer;
    ...
    function J() {
        function K(N) {
            ...
            M.appendChild(O);
            return I.serializer.serialize(M, {format: "html"})
        }
    ...
    function p() {
        function K(L, M) {
            tinymce.each(q.select("a"), function (P) {
                var N = P.parentNode, O = q.getRoot();
                if (N.lastChild === P) {
                    while (N && !q.isBlock(N)) {
    ...
    function h() {
        var M, L, ac, K, X, aa, Y, ab, N, O, Z, V, U, W = document, S = e.getDoc();
        if (!v.object_resizing || v.webkit_fake_resize === false) {
            return
        }
        d("enableObjectResizing", false);
        Z = {n: [0.5, 0, 0, -1], e: [1, 0.5, 1, 0], s: [0.5, 1, 0, 1], w: [0, 0.5, -1, 0], nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1]};
        function Q(ag) {
            var af, ae;
            af = ag.screenX - aa;
            ae = ag.screenY - Y;
            ...
            q.setStyles(K, {width: V, height: U});
        ...
        function P(ah) {
            ...
            tinymce.each(Z, function (ak, ai) {
                ...
                if (!aj) {
                    aj = q.add(S.documentElement, "div", {id: "mceResizeHandle" + ai, "class": "mceResizeHandle", style: "cursor:" + ai + "-resize; margin:0; padding:0"});
                    q.bind(aj, "mousedown", function (al) {
                        ...
                        q.setStyles(K, {left: M, top: L, margin: 0});
                ...
                q.setStyles(aj, {left: (ag * ak[0] + M) - (aj.offsetWidth / 2), top: (ae * ak[1] + L) - (aj.offsetHeight / 2)})
            });
